class Rnmr < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_sequoia: "83690d92ddbf24e6b60c79d192512b5f1f751dcfb927132d738d584ebd3a0559", filename: "rnmr--1.0.6.arm64_sequoia.bottle.1.tar.gz"
  end
